defmodule DalaDev.Deployer do
  ...
  **iOS simulator**: copies files locally into `/tmp/otp-ios-sim/beamhello/` (no network
  ...
  # Dala.Screen.Screen (or Dala.Spark.Dsl) GenServer that is already mounted and displaying will continue
  ...
  # `:dala_screen` registered process on the device. Dala.Screen.Screen's (or Dala.Spark.Dsl's) handle_info
