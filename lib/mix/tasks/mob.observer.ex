defmodule Mix.Tasks.Mob.Observer do
  @moduledoc """
  Start the Mob Observer web interface for remote node monitoring.
  ...
  def run(args) do
    ...
    Mix.shell().info("Starting Mob Observer on http://localhost:#{port}/observer")
    ...
    MobDev.Server.Endpoint.start_link()
