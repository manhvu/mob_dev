defmodule Mix.Tasks.Mob.Debug do
  use Mix.Task

  @shortdoc "Interactive debugging for mobile nodes"
  ...
  ## Examples
      ...
      mix mob.debug --eval "MyApp.Config.get(:api_key)" --node mob_qa@192.168.1.5

      # Get memory report
      mix mob.debug --memory --node mob_qa@192.168.1.5

      # Get supervision tree
      mix mob.debug --tree --node mob_qa@192.168.1.5
