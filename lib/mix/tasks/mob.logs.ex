defmodule Mix.Tasks.Mob.Logs do
  use Mix.Task

  @shortdoc "Collect and stream logs from mobile devices and cluster nodes"

  @moduledoc """
  Collects, streams, and exports logs from mobile Elixir cluster nodes.
  ...
  ## Examples
      ...
      mix mob.logs --node mob_qa@192.168.1.5

      # Filter by log level
      mix mob.logs --level error

      # Save logs to file
      mix mob.logs --save logs.jsonl --format jsonl

      # Show last N entries
      mix mob.logs --last 100
