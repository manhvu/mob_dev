defmodule Mix.Tasks.Mob.Bench do
  use Mix.Task

  @shortdoc "Run benchmarks on mobile nodes"

  @moduledoc """
  Run performance benchmarks on mobile Elixir nodes.
  ...
  ## Examples
      ...
      mix mob.bench --test test/my_bench.exs

      # Compare performance across nodes
      mix mob.bench --compare node1@host,node2@host

      # Generate HTML report
      mix mob.bench --report report.html --format html
