defmodule Mix.Tasks.Mob.Trace do
  use Mix.Task

  @shortdoc "Distributed tracing for mobile Elixir clusters"

  @moduledoc """
  Interactive distributed tracing UI for mobile Elixir clusters.

  ## Usage

      mix mob.trace                          # interactive tracing UI
      mix mob.trace --node mob_qa@192.168.1.5  # trace specific node
      mix mob.trace --export trace.json      # export to Chrome Tracing format
      mix mob.trace --modules Mob.Screen,MyApp  # trace specific modules
  ...
  ## Examples
      ...
      mix mob.trace --node mob_qa@192.168.1.5 --modules MyApp,MyAppWeb

      # Export to Chrome Tracing format
      mix mob.trace --export trace.json --duration 30
  """

  alias MobDev.Tracing
