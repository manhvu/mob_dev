defmodule Mix.Tasks.Dala.BatteryBenchIosTest do
  use ExUnit.Case, async: true

  alias Mix.Tasks.Dala.BatteryBenchIos
  ...
  describe "node_matches_prefix?/2" do
    ...
    test "rejects different app prefix (dala_qa_ios_*@10.0.0.17)" do
      refute BatteryBenchIos.node_matches_prefix?(
               :"dala_qa_ios_02628f8f@10.0.0.17",
               "test_nif_ios"
             )
    end
