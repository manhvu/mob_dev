defmodule Mix.Tasks.Dala.ProvisionTest do
  use ExUnit.Case, async: true

  alias Mix.Tasks.Dala.Provision
  ...
  describe "diagnose_xcodebuild_failure/1" do
    test "matches 'The attribute name is invalid' (App ID rejected for too long / bad chars)" do
      ...
      ** BUILD FAILED **
      ...
      # Hint is actionable — points at dala.exs and `mix dala.new`.
      assert hint =~ "config :dala_dev"
